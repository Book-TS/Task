...
const String KeyCap[5][15] = {
    ...
    {"Tab", "NULL", "Q", "W", "E", "R", "T", "Y", "U", "I", "O", "P", "[", "]", "BACK"},
    {"CAPS", "NULL", "A", "S", "D", "F", "G", "H", "J", "K", "L", ";", "'", "ENTER", "NULL"},
    {"NULL", "SHIFT", "Z", "X", "C", "V", "B", "N", "M", ",", ".", "UP", "NULL", "SHIFT", "/"},
    {"CTRL", "GUI", "NULL", "ALT", "NULL", "NULL", "SPACE", "NULL", "NULL", "NULL", "LEFT", "DOWN", "RIGHT", "NO"}};
